...
ALLOWED_HOSTS = ['www.fleetia.online', 'taki.pythonanywhere.com', 'localhost', '127.0.0.1', '192.168.1.110']
...
# Note: JWT authentication removed to simplify authentication
# Now using TokenAuthentication only
