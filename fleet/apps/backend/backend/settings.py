...
SECRET_KEY = 'django-insecure-nqg5_$2z9&zt!g2outui=0&dsa+#x0+c@l7s3_orw%qbnnmzi7'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['www.fleetia.online', 'taki.pythonanywhere.com', 'localhost', '127.0.0.1', '192.168.1.110', 'testserver']
...
# Production Security Settings (can be overridden with environment variables)
import os
...
# CORS Settings
# For development, allow all origins (mobile apps and web)
if DEBUG:
...
AWS_STORAGE_BUCKET_NAME = 'fleet-photos'
