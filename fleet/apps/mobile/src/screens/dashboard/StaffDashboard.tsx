      ...
      >
        ...
        >
          <View className="items-center">
            ...
            <Text className="text-base text-green-100 text-center mb-4">
              Manage operations for {stats?.company_name || (typeof user?.company === 'string' ? user?.company : user?.company?.name || 'your company')}
            </Text>
        ...
        <Card className="mb-6 p-5 rounded-3xl shadow-lg bg-white dark:bg-slate-800" variant="elevated">
          <Text className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2">Team Overview</Text>
          <Text className="text-sm text-slate-600 dark:text-slate-400 mb-4">Team members by role</Text>
        ...
        {/* Operations */}
        <Card className="mb-6 p-5 rounded-3xl shadow-lg bg-white dark:bg-slate-800" variant="elevated">
          <Text className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-4">Operations</Text>
